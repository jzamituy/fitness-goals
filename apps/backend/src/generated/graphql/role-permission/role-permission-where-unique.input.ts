...
import { RolePermissionRoleIdPermissionIdCompoundUniqueInput } from './role-permission-role-id-permission-id-compound-unique.input';
...
export class RolePermissionWhereUniqueInput {
    ...
    @Field(() => RolePermissionRoleIdPermissionIdCompoundUniqueInput, {nullable:true})
