...
import { GymMemberUncheckedUpdateManyWithoutCoachNestedInput } from '../gym-member/gym-member-unchecked-update-many-without-coach-nested.input';

@InputType()
export class CoachUncheckedUpdateInput {
    ...
    @Field(() => GymMemberUncheckedUpdateManyWithoutCoachNestedInput, {nullable:true})
    gymMembers?: GymMemberUncheckedUpdateManyWithoutCoachNestedInput;
}
