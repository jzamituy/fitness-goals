...
import { NutritionistUncheckedUpdateOneWithoutUserNestedInput } from '../nutritionist/nutritionist-unchecked-update-one-without-user-nested.input';
...
@InputType()
export class UserUncheckedUpdateWithoutGymMemberInput {
    ...
    @Field(() => NutritionistUncheckedUpdateOneWithoutUserNestedInput, {nullable:true})
    nutritionist?: NutritionistUncheckedUpdateOneWithoutUserNestedInput;
