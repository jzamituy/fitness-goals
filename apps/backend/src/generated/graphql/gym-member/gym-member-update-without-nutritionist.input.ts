...
import { GoalUpdateManyWithoutGymMemberNestedInput } from '../goal/goal-update-many-without-gym-member-nested.input';
...
@InputType()
export class GymMemberUpdateWithoutNutritionistInput {
    ...
    @Field(() => GoalUpdateManyWithoutGymMemberNestedInput, {nullable:true})
