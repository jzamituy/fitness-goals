...
import { MemberPlanUpdateManyWithoutPlanTemplateNestedInput } from '../member-plan/member-plan-update-many-without-plan-template-nested.input';

@InputType()
export class PlanTemplateUpdateInput {
    ...
    @Field(() => MemberPlanUpdateManyWithoutPlanTemplateNestedInput, {nullable:true})
    memberPlans?: MemberPlanUpdateManyWithoutPlanTemplateNestedInput;
}
