...
import { MemberPlanUncheckedUpdateManyWithoutPlanTemplateNestedInput } from '../member-plan/member-plan-unchecked-update-many-without-plan-template-nested.input';

@InputType()
export class PlanTemplateUncheckedUpdateInput {
    ...
    @Field(() => MemberPlanUncheckedUpdateManyWithoutPlanTemplateNestedInput, {nullable:true})
    memberPlans?: MemberPlanUncheckedUpdateManyWithoutPlanTemplateNestedInput;
}
