...
export class UserRoleUpdateManyWithoutRoleNestedInput {
    ...
    set?: Array<Prisma.AtLeast<UserRoleWhereUniqueInput, 'id' | 'userId_roleId'>>;

    @Field(() => [UserRoleWhereUniqueInput], {nullable:true})
    @Type(() => UserRoleWhereUniqueInput)
    disconnect?: Array<Prisma.AtLeast<UserRoleWhereUniqueInput, 'id' | 'userId_roleId'>>;

    @Field(() => [UserRoleWhereUniqueInput], {nullable:true})
    @Type(() => UserRoleWhereUniqueInput)
    delete?: Array<Prisma.AtLeast<UserRoleWhereUniqueInput, 'id' | 'userId_roleId'>>;

    @Field(() => [UserRoleWhereUniqueInput], {nullable:true})
    @Type(() => UserRoleWhereUniqueInput)
    connect?: Array<Prisma.AtLeast<UserRoleWhereUniqueInput, 'id' | 'userId_roleId'>>;
