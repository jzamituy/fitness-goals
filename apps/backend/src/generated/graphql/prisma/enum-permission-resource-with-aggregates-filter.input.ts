...
import { NestedEnumPermissionResourceWithAggregatesFilter } from './nested-enum-permission-resource-with-aggregates-filter.input';
import { NestedIntFilter } from './nested-int-filter.input';
import { NestedEnumPermissionResourceFilter } from './nested-enum-permission-resource-filter.input';

@InputType()
export class EnumPermissionResourceWithAggregatesFilter {
