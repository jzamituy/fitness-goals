...
import { NestedEnumPlanStatusWithAggregatesFilter } from './nested-enum-plan-status-with-aggregates-filter.input';
import { NestedIntFilter } from './nested-int-filter.input';
import { NestedEnumPlanStatusFilter } from './nested-enum-plan-status-filter.input';

@InputType()
export class EnumPlanStatusWithAggregatesFilter {
