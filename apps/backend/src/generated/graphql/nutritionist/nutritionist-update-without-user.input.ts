...
import { GymMemberUpdateManyWithoutNutritionistNestedInput } from '../gym-member/gym-member-update-many-without-nutritionist-nested.input';

@InputType()
export class NutritionistUpdateWithoutUserInput {
    ...
    @Field(() => GymMemberUpdateManyWithoutNutritionistNestedInput, {nullable:true})
